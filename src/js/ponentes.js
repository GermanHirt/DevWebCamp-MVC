(function() {
    ...
    if(ponentesInput) {
        ...
        function mostrarPonente() {
            ...
            if(ponentesFiltrados.length > 0) {
                ponentesFiltrados.forEach(ponente => {
                    ...
                    ponenteHTML.onclick = seleccionarPonete
        ...
        function seleccionarPonete(e) {
            const ponente = e.target;

            // Remover la clase previa
            const ponetePrevio = document.querySelector('.listado-ponentes__ponente--seleccionado')
            if(ponetePrevio) {
                ponetePrevio.classList.remove('listado-ponentes__ponente--seleccionado')
            }
