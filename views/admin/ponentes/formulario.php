    ...
    <?php if(isset($ponente->imagen_actual)) { ?>
        ...
        <div class="formulario__imagen">
            ...
            <picture>
                ...
                <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.webp" type="image/png">
...
<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">Información Extra (Separadas por coma)</legend>
